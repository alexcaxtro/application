...
<div class="container">
    ...
    <tbody>
        <tr>
            ...
            <td class=" col-md-6">
                <input id="rut" name="rut" type="text" class="form-control input-md" style="border: 1px solid;" required="true" placeholder="URGENCIAS" disabled>
            </td>
            <td class=" col-md-6">
...
<!-- --------------Clave del médico ---------------------------------->
    <div class="form-group row">
        <label class="col-md-2">Confirmar Solicitud</label>
        <div class="col-md-2">
